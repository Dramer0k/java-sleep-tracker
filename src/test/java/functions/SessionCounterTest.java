...
class SessionCounterTest {
    ...
    @Test
    void testSessionCounterTrue() {
        Assertions.assertEquals(4, sessionCounter.apply(sleepSessions).getResult());
    }

    @Test
    void testSessionCounterFalse() {
        Assertions.assertNotEquals(5, sessionCounter.apply(sleepSessions).getResult());
    }
